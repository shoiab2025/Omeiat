...
SECRET_KEY = 'django-insecure-4@5mav*^dbytop-ahr2dw*qzg)r+6$$a7+pd&9pcqnj6d$47wm'
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "Omeiat",
    "site_logo": "app/images/logo.png",  # optional
    "welcome_sign": "Welcome to the Omeiat Admin",
    "copyright": "Omeiat © 2025",

    # Theme and layout
    "theme": "cerulean",  # or cerulean, darkly, flatly, etc.
    "show_sidebar": True,
    ...
    # Sidebar links for models or apps
    "side_menu": [
