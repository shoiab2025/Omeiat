    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Nursery', 'Nursery'), ('Primary', 'Primary'), ('High School', 'High School'), ('College', 'College'), ('University', 'University'), ('Vocational', 'Vocational'), ('Other', 'Other')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schooling', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('reference_by_1', models.CharField(blank=True, max_length=100, null=True)),
                ('reference_by_2', models.CharField(blank=True, max_length=100, null=True)),
                ('joining_availability', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.AddField(
            ...
            name='omeiat_zone',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.omeiatzones'),
        ),
        migrations.CreateModel(
            name='WorkExperience',
            fields=[
