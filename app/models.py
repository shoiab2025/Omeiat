...
class Institution(models.Model):
    ...
    logo = models.ImageField(upload_to="app/static/institution_logos/", blank=True, null=True)
...
class User(AbstractUser):
    ...
    profile_picture = models.ImageField(upload_to='app/static/profiles/', blank=True, null=True)
