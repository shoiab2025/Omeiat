...
class User(AbstractUser):
    ...
    schooling = models.CharField(max_length=200, blank=True)
    ...
    reference_by_1 = models.CharField(max_length=100, blank=True)
    reference_by_2 = models.CharField(max_length=100, blank=True)
    joining_availability = models.CharField(max_length=200, blank=True)
